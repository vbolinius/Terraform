...
variable "my_london_subnets" {
  default = {
    vpc1_london         = "172.25.0.0/16"
    vpc1_london_private = "172.25.100.0/24"
    vpc1_london_public = "172.25.200.0/24"
  }
}

variable "my_london_subnet_names" {
  default = {
    vpc1_london_private = "VB-VPC-02-SN-PRIVATE"
    vpc1_london_public = "VB-VPC-02-SN-PUBLIC"
  }
}
...
variable "my_london_routetable_names" {
  default = {
    vpc1_london_private = "VB-VPC-02-RT-PRIVATE"
    vpc1_london_public = "VB-VPC-02-RT-PUBLIC"
    vpc1_london_default = "VB-VPC-02-RT-DEFAULT"
  }
}

variable "my_london_igw_names" {
  default = {
    vpc1_london_igw = "VB-VPC-02-IGW"
  }
}
...
variable "my_london_eip_names" {
  default = {
    vpc1_london_public_NATGW_IP = "VB-VPC-02-PUBLIC-SN-NAT-EIP"
  }
}
...
variable "my_london_nat_gw_names" {
  default = {
    vpc1_london_public_nat_gw = "VB-VPC-02-PUBLIC-SN-NATGW"
  }
}
...
variable "my_london_vm_names" {
  default = {
    vpc1_london_public_linux_1 = "VB-VPC-02-PUBLIC-LINUX-01"
    vpc1_london_private_linux_1 = "VB-VPC-02-PRIVATE-LINUX-01"
  }
}

variable "my_london_vm_IP_addresses" {
  default = {
    vpc1_london_public_linux_1 = "172.25.200.10"
    vpc1_london_private_linux_1 = "172.25.100.10"
  }
}
...
variable "my_london_security_group_names" {
  default = {
    vpc1_london_remote_access = "VB-VPC-02-SG-REMOTE-ACCESS"
  }
}